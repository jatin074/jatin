...
export default function DesignProcess() {
    ...
    return (
        <div className='container'>
            <div className='processSection lg:px-[50px] relative z-10'>
                <div>
                    <div className="d-flex flex-column justify-content-between">
                        <h3 data-text="Process" className="md:text-[48px] sm:text-[32px] text-[26px] font-semibold text-center mt-[40px] mb-[70px] text-[#ffffff] w-full reflection relative">
