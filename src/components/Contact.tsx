            ...
            <div className='sm:pt-[60px] pt-[40px] sm:px-[30px] relative z-10 lg:w-[90%] mx-auto'>
                ...
                <div className='contact-form flex items-center justify-center w-full'>
                    <div className='flex items-center justify-center flex-wrap gap-[30px] w-full'>
                        ...
                        <a href="mailto:jayti0474@gmail.com" className='conact-card'><div className='contact-list-icon'><MdEmail /></div><p className='sm:text-[18px] text-[16px] font-medium sm:leading-[32px] leading-[26px] text-center card-text transition-all duration-300 ease-in-out min-h-[50px]'>jayti0747@gmail.com</p></a>
